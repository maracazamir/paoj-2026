            ...
            try {
                switch (option) {
                    ...
                    case "2":
                        ...
                        System.out.print("Materie ("  /* TODO: afișează Subject.values() */ + Arrays.toString(Arrays.stream(Subject.values()).map(Subject::name).toArray()) + "): ");
                    ...
                    case "5":
                        Map<Subject, Double> medii = service.getAveragePerSubject();
                        ...
                        {
                            for (Map.Entry<Subject, Double> entry : medii.entrySet()) {
